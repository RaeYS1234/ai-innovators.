      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="inline-block mb-4 rounded-lg bg-white p-3 shadow-sm hover:opacity-95 transition-opacity">
              <Image
                src="/logo.png"
                alt="AI Innovators"
                width={400}
                height={96}
                className="h-16 w-auto max-w-[min(100%,360px)] object-contain object-left sm:h-[4.5rem]"
              />
            </Link>
